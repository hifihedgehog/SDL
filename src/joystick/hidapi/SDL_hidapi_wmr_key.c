/*
  The configuration key of the Windows Mixed Reality devices, from Monado
  src/xrt/drivers/wmr/wmr_config_key.h at commit 6b41c5b. Monado derived it
  from raw configuration blocks read with https://github.com/pH5/wmr-config.
  See SDL_hidapi_wmr_proto.h.
...
/* XOR-ed with the configuration JSON of every Windows Mixed Reality device
   Monado has seen, repeating every 1024 bytes */
const uint8_t SDL_WMR_ConfigKey[SDL_WMR_KEY_LENGTH] = {
